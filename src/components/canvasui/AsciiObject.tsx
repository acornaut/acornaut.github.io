...
function removeNearWhiteBackground(canvas: HTMLCanvasElement) {
  ...
  for (let index = 0; index < image.data.length; index += 4) {
    ...
    if (red > 244 && green > 244 && blue > 244) image.data[index + 3] = 0;
  }
...
async function decodeImage(
  ...
  if (!vector) {
    ...
    if (decoded) return removeNearWhiteBackground(decoded);
  }
  ...
  return removeNearWhiteBackground(drawToCanvas(image, width * scale, height * scale));
}
